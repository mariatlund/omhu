      ...
      <div className="grid space-y-10 style-body-small md:style-body py-10 md:flex md:py-14 md:gap-10 md:space-y-0 md:justify-between container">
        ...
        <div className="grid space-y-1">
          ...
          <span className="uppercase">
            Phone:{" "}
            <a href="tel:+4526118956" className="text-link-50 hover:text-blue-50">
              +45 26 11 89 56
            </a>
          </span>
          <span className="uppercase">
            Email:{" "}
            <a href="mailto:hello@omhucph.com" className="text-link-50 hover:text-blue-50">
              hello@omhucph.com
            </a>
          </span>
        </div>
        <div className="grid space-y-1">
          ...
          <a href="" download className="text-link-50 hover:text-blue-50">
            Terms & Conditions
          </a>
          <Link href="/faq" className="text-link-50 hover:text-blue-50">
            Frequently Asked Questions (FAQ)
          </Link>

          <h3 className="style-h4 uppercase text-white pt-10">Follow us</h3>
          <div className="flex gap-x-5 pt-2">
            <Link href="https://www.instagram.com/omhu_cph/" target="_blank" className="bg-white w-10 h-10 rounded-full flex items-center justify-center flex-none hover:bg-link-50">
            ...
            <Link href="https://www.tiktok.com/@omhu_cph" target="_blank" className="bg-white w-10 h-10 rounded-full flex items-center justify-center flex-none hover:bg-link-50">
        ...
        <div className="grid space-y-1">
          ...
          <Link href="/shop" className="text-link-50 hover:text-blue-50">
            Shop
          </Link>
          <Link href="/shop" className="text-link-50 hover:text-blue-50">
            Showroom
