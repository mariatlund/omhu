...
function Footer() {
  return (
    <footer className="bg-blue text-link-50 font-semibold grid space-y-10 style-body-small md:style-body p-10">
      <Image src={Logo} alt="OMHU Logo" className="w-24 justify-self-center border border-white" />
