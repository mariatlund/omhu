...
const bluePhoneSVG = (
  <svg id="Layer_1" viewBox="0 0 673.47 180" fill="currentColor" className="inset-0 w-52 md:w-full">
    <path
      className="cls-1"
...
const blueDesktopSVG = (
  <svg id="Layer_1" viewBox="0 0 119.08 596.65" fill="currentColor" className="inset-0 w-14 md:w-20">
...
function FeaturedSection({ bgColour, image, title, description, buttonLabel, buttonLink }: FeaturedSectionProps) {
  return (
    <section className={clsx(bgColour === "blue" ? "bg-blue text-white" : "bg-white text-blue", "relative overflow-hidden")}>
      {bgColour === "blue" ? (
        <div className="absolute w-full h-full overflow-hidden flex">
          <div className="grid place-items-start w-full">{blueDesktopSVG}</div>
          <div className="grid place-items-end w-full">{bluePhoneSVG}</div>
        </div>
      ) : null}

      <div className="container grid py-10 md:grid-cols-2 md:gap-x-10 relative">
